...
{    
    ...
    //draw_roundrect_color( mouse_x, mouse_y - text_height*0.27, mouse_x + text_width/5.1, mouse_y + 5, argument3, argument3, false);
    draw_roundrect_color( mouse_x, mouse_y, mouse_x + text_width/5.1, mouse_y + text_height*0.27, argument3, argument3, false);
    ...
    draw_text_transformed( mouse_x + 3, mouse_y + 2, argument0,0.20,0.25,1);
