...
//SKILL A
if a1_key && global.a_cd <= 0 {
    global.a_cd = global.maxa_cd;
    image_index = 0;
    Aspellflash = 1;
    state = elrona1;
    }
...
//SKILL B
if a2_key && global.b_cd <= 0 && !instance_exists(o_elronBbuff) {
    global.b_cd = global.maxb_cd;
    Bspellflash = 1;
...
//ULT
if a3_key && global.c_cd <= 0 && !instance_exists(o_elronultsigil) {
    global.c_cd = global.maxc_cd;
    Cspellflash = 1;
    image_index = 0;
    state = elronult;
    }
