...
//Remembers the position of the enemy
var xp = x;
var yp = y;
...
///Checks if enemy's CORNERS would touch the VOID or WALL
...
//After checking for collison, move enemy back to floor if enemy collides through a wall
x = xp;
y = yp;
