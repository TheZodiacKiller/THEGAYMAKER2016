...
switch (sprite_index) {
    case spr_warriorAtt1Right:
        xx = x+16;
        yy = y;
        var damage = instance_create(xx, yy, o_cleaveright);
        break;
    
    case spr_warriorAtt1Left:
        xx = x-16;
        yy = y;
        var damage = instance_create(xx, yy, o_cleaveleft);
    break;
    
    case spr_warriorAtt1Up:
        xx = x;
        yy = y-16;
        var damage = instance_create(xx, yy, o_cleaveup);
    break;
    
    case spr_warriorAtt1Down:
        xx = x;
        yy = y+16;
        var damage = instance_create(xx, yy, o_cleavedown);
    break;
